...
- Team collaboration and communication (group projects, hackathons, academic teamwork)
...
- **Collaborators:** One classmate
- **What I learned:** Secure login systems, database integration, responsive UI design
- **Outcome:** Delivered a functional e-commerce platform with product reviews and admin controls

### Project 2: Note-Taking App (Full-Stack JavaScript)
- **Skills used:** Node.js, Express, REST API design, CRUD operations, front-end integration, authentication (JWT), database persistence (MySQL/MongoDB)
- **Date:** 2025
- **Collaborators:** Individual project
- **What I learned:** API architecture, route/controller design, input validation, error handling, endpoint security, front-end/back-end integration
...
I primarily share my work on **LinkedIn** and **GitHub**.
